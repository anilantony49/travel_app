...
part of 'north_america.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class NorthAmericaDestinationModelsAdapter
    extends TypeAdapter<NorthAmericaDestinationModels> {
  @override
  final int typeId = 6;

  @override
  NorthAmericaDestinationModels read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return NorthAmericaDestinationModels(
  ...
  @override
  void write(BinaryWriter writer, NorthAmericaDestinationModels obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is NorthAmericaDestinationModelsAdapter &&
