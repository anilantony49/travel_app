...
class AsiaDestinationModelsAdapter extends TypeAdapter<AsiaDestinationModels> {
  @override
  final int typeId = 7;

  @override
  AsiaDestinationModels read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return AsiaDestinationModels(
  ...
  @override
  void write(BinaryWriter writer, AsiaDestinationModels obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is AsiaDestinationModelsAdapter &&
